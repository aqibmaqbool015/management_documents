            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center ">
                    <div className="flex items-center">
                        <span>
                            <img src={image.logo} alt="Logo" className="md:w-[140px] w-[110px] h-auto" />
                        </span>
                    </div>
                    <nav className="hidden md:flex space-x-4">
                        ...
                        <Link href="/auction" className="px-2 text-customColorNav text-[15px] font-medium hover:text-customBlue hover:underline underline-offset-8">AUCTION</Link>
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <span>
                            <img src={image.bell} alt="Bell" className="w-[18px] h-auto" />
                        </span>
                        <button className="bg-customBlue text-white py-2 px-5 rounded-[25px] font-medium">+ SELL</button>
                        <div className="flex items-center">
                            <span>
                                <img src={image.user} alt="User" className="w-[22px] h-auto" />
                            </span>
