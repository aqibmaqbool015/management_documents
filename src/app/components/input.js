...
const CustomInput = ({ label, type, id, name, placeholder, value, onChange, labelClass, icon, error }) => {
  ...
  return (
    <div className="mt-[12px]">
      ...
      <div className="relative">
        ...
        />
        <img src={icon} alt="" className="w-[20px] h-[20px] inline-block object-contain absolute left-3 top-4" />
