...
export default function OtpPage() {
    ...
    const handleNewClick = (e) => {
        ...
        router.push('/new-password');  // Navigates to the OTP page
    };
    ...
    const [time, setTime] = useState(90); // 90 seconds timer
        ...
        <div className=" min-h-screen flex flex-col md:flex-row bg-gray-50">
            ...
            <div className="w-full md:w-[50%] flex flex-col items-center">
                ...
                <div className="max-w-md w-full py-8 md:py-16 px-4 md:px-0">
                    <h1 className="text-2xl font-semibold mb-2 text-center text-[30px]
                    text-customBlue">OTP Verification</h1>
                    <h6 className="text-2xl font-normal mb-8 text-center text-[14px] leading-normal
                    text-customBlue">Please enter the 6 digit code sent to alibaba@gmail.com </h6>
                    ...
                    <form className="space-y-4" onSubmit={handleNewClick}>
                        ...
                        <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-[25px] shadow-sm text-sm font-medium text-white 
                        bg-customBlue !mt-7">
                            Send
                        </button>
            ...
            <div className="w-full md:w-[50%]">
                <img src={image.image} alt="Car Dealership"
